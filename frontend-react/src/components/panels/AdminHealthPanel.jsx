    ...
    <div className="animate-fade-in-up space-y-8">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-rose-900 to-pink-900 rounded-[2rem] p-8 relative overflow-hidden shadow-2xl border border-rose-500/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="relative z-10 flex items-center gap-6">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight">Master Vitals Sync</h2>
            <p className="text-rose-200 font-medium mt-1 text-sm md:text-base">Biometric Data End-to-End Encrypted</p>
          </div>
        </div>
        <div className="relative z-10 bg-white/10 px-6 py-3 rounded-2xl backdrop-blur-md border border-white/10 text-center flex items-center gap-4">
          <div className="text-right">
            <p className="text-rose-200 text-[10px] font-bold uppercase tracking-widest mb-1">Overall Health</p>
            <p className="text-xl font-black text-white">96<span className="text-sm text-rose-300 ml-1">/100</span></p>
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-1 bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl p-8 rounded-[2rem] border border-white/60 dark:border-slate-700/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none flex flex-col h-full">
          <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-6">Recent Scans</h3>
          <div className="space-y-4 flex-1">
            ...
            <div className="bg-emerald-50/50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800/30 rounded-2xl p-4 flex items-center justify-between hover:bg-white dark:hover:bg-slate-800/60 transition-colors group cursor-default">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-[1rem] bg-white dark:bg-emerald-500/10 flex items-center justify-center text-emerald-500 dark:text-emerald-400 shadow-sm dark:shadow-none border border-emerald-50 dark:border-emerald-500/20 group-hover:scale-105 transition-transform">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
                </div>
                <div>
                  <p className="font-bold text-slate-800 dark:text-white text-sm">Blood Pressure</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">118/76 mmHg</p>
                </div>
              </div>
              <span className="bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-[10px] px-2.5 py-1 rounded-md font-bold uppercase tracking-widest">Optimal</span>
            </div>
            
            <div className="bg-amber-50/50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/30 rounded-2xl p-4 flex items-center justify-between hover:bg-white dark:hover:bg-slate-800/60 transition-colors group cursor-default">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-[1rem] bg-white dark:bg-amber-500/10 flex items-center justify-center text-amber-500 dark:text-amber-400 shadow-sm dark:shadow-none border border-amber-50 dark:border-amber-500/20 group-hover:scale-105 transition-transform">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                </div>
                <div>
                  <p className="font-bold text-slate-800 dark:text-white text-sm">Body Temp</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">99.1 °F</p>
                </div>
              </div>
              <span className="bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 text-[10px] px-2.5 py-1 rounded-md font-bold uppercase tracking-widest">Elevated</span>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 rounded-2xl p-4 flex items-center justify-between hover:bg-white dark:hover:bg-slate-800/80 transition-colors group cursor-default">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-slate-800 dark:text-white text-sm">Stress Level</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">Based on HRV</p>
                </div>
              </div>
              <span className="text-slate-600 dark:text-slate-400 font-black text-lg">Low</span>
            </div>
          </div>
